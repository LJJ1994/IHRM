...
public class ArchiveService {
	...
	/**
     * 数据归档
	 * @param archiveDate	归档的日期 201908
	 ...
	 */
	public List<ArchiveMonthly> findByYear(String companyId, String departmentId, String year) {
		return archiveMonthlyDao.findByCompanyIdAndDepartmentIdAndArchiveYear(companyId, departmentId, year);
    }
